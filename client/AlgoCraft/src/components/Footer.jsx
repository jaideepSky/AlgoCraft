...
export function Footer() {
  return (
    <footer className="bg-gray-50 dark:bg-gray-900 border-t border-gray-200 dark:border-purple-500/10 py-12 px-4 sm:px-6 lg:px-8 transition-colors">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Copyright */}
        <div className="pt-8 border-t border-gray-200 dark:border-purple-500/10 text-center text-gray-600 dark:text-gray-400">
